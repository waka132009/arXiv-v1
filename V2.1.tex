...
\begin{tenumerate}
  ...
  \item \hyperref[list:screens]{Screens A--D} remove confounders: Compton-thick absorption, extreme inclination, and high compactness ($\ellhard$ required).
...
\enddata
\tablecomments{after applying Screens A--D; failure to recover $\ge2$ hooks falsifies SSPE.}
\end{deluxetable*}
...
\noindent\textbf{Screens A--D \ref{sec:obs}} Exclude Compton-thick, extreme inclination; require $\ell<\ellcrit$.\\
