...
\noindent\textbf{Screen C (geometry/obscuration):} exclude Compton-thick/heavily absorbed cases and extreme inclination; if a hook is plausibly blocked at useful S/N (i.e., non-decidable under Appendix~\ref{app:protocol}), treat it as \emph{missing} rather than failed.\\
