...
\startdata
Hook 1 &
Hard X-ray spectrum with reliable background; model-comparison (AICc/BIC) &
Yes &
After screens, the vetted high-spin/high-$\lambda$ sample systematically prefers featureless continua (no shoulder)\\
Hook 2 &
Simultaneous (or tightly interleaved) X-ray + UV/optical light curves; Fourier lags &
Partly &
After screens, lag--energy slopes fail to be positive/monotone within epochs across the bright subset\\
Hook 3 &
Hard-component X-ray polarimetry; EVPA reference to disk plane; spin/$\lambda$ proxies &
Limited &
After screens, EVPA shows no preference for equatorial alignment and no trend with inferred spin/$\lambda$\\
\enddata
