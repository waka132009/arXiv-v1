...
\item [D]\textbf{Compactness screen:} exclude pair-opaque states ($\ell\gtrsim\ellcrit$) where the hard component is suppressed; treat such cases as \emph{screened} rather than \emph{failed}.
\end{titemize}
