...
We measure $\tau(E)$ relative to a fixed reference band $E_{\rm ref}$ (adopt $E_{\rm ref}=2$--4~keV); define $\tau>0$ when the band at $E$ lags the reference band.\\
...
\noindent\textbf{Toy mapping (optional visual aid).} See Fig.~\ref{fig:toy_mapping}.
