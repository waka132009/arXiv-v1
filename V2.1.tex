...
\begin{titemize}
  \item[Hook 1] \textbf{Hard X/MeV shoulder:} a hard excess/shoulder beyond a featureless baseline continuum.\\The featureless baseline continuum is defined operationally as a shoulder-free continuum model fitted with the same background and line-of-sight absorption treatment as the shoulder-inclusive comparison model.
