...
\clearpage
\par\smallskip
\noindent\textem{Toy mapping (visual aid).}
Figure~\ref{fig:fig_appendix} provides an illustrative mapping from the equilibrium spin $a_{\rm eq}$
to two hook observables ($\tau_{\rm FeK}$ and $f_{\rm hook}$). It is optional and not required for Tier-1 execution.
