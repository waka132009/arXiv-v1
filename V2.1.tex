...
We adopt $a_* \ge 0.95$ as an operational high-spin criterion, allowing margin for systematic uncertainties in spin estimators relative to the near-threshold activation($a_* \simeq 0.97$) implied by the phenomenology.
...
If an observable is effectively inaccessible at useful S/N, treat it as \emph{missing} rather than \emph{failed}.
