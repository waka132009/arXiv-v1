...
\begin{figure}[!htbp]
  ...
  for a fiducial coupling $\epsilon_{\rm coup}$ (solid curve). The monotonic drift toward
...
(\emph{equilibration timescale} $\tau_{\rm eq}$ is defined as the cumulative active time required for $a_\ast$ to reach $a_{\rm eq}$ within a fixed tolerance; see Fig.~\ref{fig:fig_eqtime}).
