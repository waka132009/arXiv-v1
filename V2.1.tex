...
SSPE therefore targets \emph{joint observational coherence}: after applying Screens~A--D, the model is evaluated by the co-occurrence of Hooks~1--3 within the same source/epoch, with quantitative model selection (e.g., $\Delta\mathrm{IC}\!\ge\!6$) applied where a competing spectral/timing description exists.
