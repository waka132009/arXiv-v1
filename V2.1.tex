...
\begin{figure*}[p]
  ...
  \emph{Right:} Observable fraction $f_{\rm hook}$ (hard X/MeV shoulder or 2--10~keV polarization) vs.\ $a_{\rm eq}$ from the toy illustrative mapping; the fraction rises steeply toward low $a_{\rm eq}$.\\
