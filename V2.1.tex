...
Operationally, epoch constancy requires that Eq.~\ref{eq:epoch-constancy} is satisfied for both HR and flux for the bulk of the measurements within the block (e.g., at least 95\% of points).
...
Falsification is triggered when
\begin{equation}\label{eq:Population-level falsification-1}
...
\end{equation}\label{eq:Population-level falsification-2}
