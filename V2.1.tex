...
\section{Semi-analytic parameter study}\label{sec:results}
...
\tablecaption{\textbf{At a glance:} How power repartitions at high $\lambda$ across mechanisms. \textbf{Bottom line:} the equatorial channel sustains $L/L_{\rm Edd}\!>\!1$ \emph{and} imposes a spin ceiling $a_{\rm eq}\!\approx\!a_{\rm th}$, complementary to slim-disk \citep{Abramowicz1988} (no ceiling) and BZ/MAD (polar power, $a_{\rm eq}\!\sim\!0.5$--$0.7$).\label{tab:mech-contrast}}
