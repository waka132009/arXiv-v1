...
\enddata
\tablecomments{
after applying Screens A–D; we adopt $\Delta \mathrm{IC}\ge 6$
(e.g., $\Delta$BIC or $\Delta$AICc) as a pragmatic strong-evidence decision threshold
following common usage in model selection (e.g., \citealt{KassRaftery1995}; \citealt{BurnhamAnderson2002});
failure to recover $\ge 2$ hooks falsifies SSPE.
}
\end{deluxetable*}
