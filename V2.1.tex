...
We adopt a conventional threshold (fiducially $\BICmetric \ge \ICcrit$) to keep the Tier-1 decision rule executable and reproducible, but the protocol does not hinge on this single value.

In practice, we recommend reporting the classification stability under a small bracket around the threshold (e.g., $\BICmetric\in[4,10]$) as a sensitivity check; sources that flip classification within this bracket are labeled ambiguous and deferred to Tier-2.
