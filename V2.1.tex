...
\]
over the block, where $(HR_0,F_0)$ are the block means and $(\sigma_{\rm HR},\sigma_F)$ are the $1\sigma$ uncertainties of\\individual measurements (not the standard error of the block mean), including instrumental noise.
