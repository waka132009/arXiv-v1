...
\small
\begin{tenumerate}
\item \textbf{Screen first:} apply the screens above (spin/accretion/geometry/compactness) and document any missing observables.
...
After screens, the absence of two or more hooks in vetted high-spin/high-$\lambda$ samples falsifies the SSPE contribution; otherwise the source passes the Tier-1 screen.
