...
In rare geometries a fraction may escape directly, producing ultra-fast, ultra-hard flares that would probe the ergoregion almost directly.}
...
Most of the time this energy is promptly reprocessed into the hard X/MeV shoulder (Hook~1) and lag-hardening signatures (Hook~2), 
with only modest direct leakage beyond the disk and torus.
...
In that case SSPE would produce \emph{direct} signatures on timescales of a few $r_g/c$, much shorter than the thermal and viscous response of the disk.
