...
% --- Parameter-space split (single-column figures) ---
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.98\columnwidth]{fig10a_Reff100.pdf}
  \vspace{-2pt}
  \caption{\textbf{Viable region lies \emph{outside} the $\ell{=}30$ contour (a).}
  $R_{\rm eff}=100\,r_g$. Color encodes peak $L_{\rm tot}/L_{\rm Edd}$; the black contour marks $\ell{=}30$.}
  \label{fig:param-a}
\end{figure}

\begin{figure}[b!]
  \centering
  \includegraphics[width=0.98\columnwidth]{fig10b_Reff1000.pdf}
  \vspace{-2pt}
  \caption{\textbf{Viable region lies \emph{outside} the $\ell{=}30$ contour (b).}
  $R_{\rm eff}=1000\,r_g$. Color encodes peak $L_{\rm tot}/L_{\rm Edd}$; the black contour marks $\ell{=}30$.}
  \label{fig:param-b}
\end{figure}
