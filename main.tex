...
\begin{figure}[t!]
  ...
  \vspace{-2pt}
  \caption{\textbf{Outside the $\ell{=}30$ contour (a).}
  $R_{\rm eff}=100\,r_g$; color encodes peak $L_{\rm tot}/L_{\rm Edd}$; black: $\ell{=}30$.}
  \label{fig:param-a}
\end{figure}
...
\begin{figure}[t!]
  ...
  \vspace{-2pt}
  \caption{\textbf{Outside the $\ell{=}30$ contour (b).}
  $R_{\rm eff}=1000\,r_g$; color encodes peak $L_{\rm tot}/L_{\rm Edd}$; black: $\ell{=}30$.}
  \label{fig:param-b}
\end{figure}
