...
% "See also" one-liner（AASTeX安全・改行と余白つき）
...
(Sec.~\ref{sec:obs}).
The possibility of extracting rotational energy from the ergoregion was first pointed out by \citet{Penrose1969,Penrose2002}.
...
\tldr{After screens, three hooks—MeV shoulder, lag hardening, and equator-aligned polarization—should co-occur in the bright, high-spin subset.}
