...
(i) a hard X-ray high-energy excess (“shoulder”) favored over a featureless continuum by $\Delta$AIC or $\Delta$BIC $\ge 6$ in the observed 20–120 keV band (rest $\sim$0.3–1 MeV at $z\gtrsim6$);
...
We highlight three testable signatures expected to co-occur at high spin and high Eddington ratio under transparency ($\ell\!\lesssim\!30$):
\begin{itemize}
\item \textbf{Hard-X shoulder}: a high-energy excess favored over a featureless continuum by $\Delta$AIC or $\Delta$BIC $\ge 6$ in 20--120 keV (obs).
